...
void print_usage()
{
    printf( "\tUsage: mtrlgenf FILENAME\n\n"
            "mtrlgenf is a many task reinforcement learning problem generator.\n"
            "FILENAME should be a premade file containing all of the problems intended specifications.\n"
            "These specifactions will be used as parameters for generating the problem and should be\n"
            "listed by keyword, colon then the value, this value might be an array in which case it\n"
            "should be enclosed in brackets.\n"
            "Note: The generator will not detect an array with too many values. Also multi-line comments\n"
            "are started with \"/*\" and ended with \"*/\".\n"
            "Below is a list of problem types, along with a short description and a list of paramaters,\n"
            "any optional parameters are in brackets.\n\n"
            "1. Maze\n"
            "Generates a random STATESxACTIONS maze with TASKS goal states. One of the outputs is a\n"
            "transition graph(stateXaction) with states numbered left to right from top to bottom\n"
            "starting with state 0. Has -1 for an invalid state, action pair.\n"
            "CLASS:             Needs to be set to \"maze\", no quotes.\n"
            "TASKS:             The number of tasks/goalstates in the maze.\n"
            "STATES:            The height of the maze, the maze will actually have STATES*ACTIONS states.\n"
            "ACTIONS:           The width of the maze, the maze will actually have STATES*ACTIONS states.\n"
            "[LOWER BOUND:]     A vector of length TASKS, sets the reward for task i to (LOWER BOUND)[i].\n"
            "[SEED:]            A seed for the random number generator to repeat prior runs.\n"
            "[OUTPUT FILENAME:] The file to print the generated problem to. Default: FILENAME.out\n\n"
            "2. Random Problem\n"
            "Generates a random problem and outputs it to a file in MATLAB syntax."
            "CLASS:                Needs to be set to \"random problem\", no quotes.\n"
            "TASKS:                The number of tasks.\n"
            "STATES:               The number of possible states.\n"
            "ACTIONS:              The number of possible actions.\n"
            "[CORRELATION:]        A TASKSxTASKS matrix where element (i,j) of the matrix is the\n"
            "                      correlation coefficient between tasks i and j. Due to random generation\n"
            "                      the end result might have widely varying correlation coefficients.\n"
            "                      Default: The identity matrix.\n"
            "[DENSITY:]            The percentage sparsity of the generated reward matrix.\n"
            "[MEAN:]               A vector of length TASKS, sets the mean of the rewards on a per task\n"
            "                      basis. Default: All values set to zero.\n"
            "[STANDARD DEVIATION:] A vector of length TASKS, sets the standard deviation of the rewards on a\n"
            "                      per task basis. Default: All values set to 1.\n"
            "[LOWER BOUND:]        A vector of length TASKS, sets the minimum reward on a per task basis.\n"
            "[UPPER BOUND:]        A vector of length TASKS, sets the maximum reward on a per task basis.\n"
            "[SEED:]               A seed for the random number generator to repeat prior runs.\n"
            "[COMMENT:]            The type of comment to use in the output.\n"
            "[OUTPUT FILENAME:]    The file to print the generated problem to. Default: FILENAME.out\n\n"
            "Example file:\n\n correlation: [1 0.2 0.7 1] tasks: 2 states: \n\n\t17 \nactions: 3 class: "
            "random problem\ncomment: ;;\n\n");
}
